...
# 1 "<built-in>" 1
# 1 "main.s" 2
# 1 "/opt/microchip/xc8/v2.46/pic/include/xc.inc" 1 3
...
# 723 "/opt/microchip/mplabx/v6.20/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8/pic/include/pic_as_chip_select.inc" 3
# 1 "/opt/microchip/mplabx/v6.20/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8/pic/include/proc/pic16f887.inc" 1 3
# 47 "/opt/microchip/mplabx/v6.20/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8/pic/include/proc/pic16f887.inc" 3
INDF equ 0000h
...
EECON2 equ 018Dh
# 2818 "/opt/microchip/mplabx/v6.20/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8/pic/include/proc/pic16f887.inc" 3
...
# 724 "/opt/microchip/mplabx/v6.20/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8/pic/include/pic_as_chip_select.inc" 2 3
...
auto_size SET 0
ENDM
# 8 "/opt/microchip/xc8/v2.46/pic/include/xc.inc" 2 3
# 2 "main.s" 2
...
; Verifico se o valor d = 0
    ...
    btfss STATUS, 2 ; Verifico se a flag ((STATUS) and 07Fh), 2 do reg STATUS está setado, ou seja, se d = 0.
    ...
    bsf PORTE, 1 ;Estou chamando o pino ((PORTE) and 07Fh), 1 de "Led" ; Estou ligando o PORTE, 1 ;Estou chamando o pino ((PORTE) and 07Fh), 1 de "Led" do ((PORTE) and 07Fh), 1 para indicar o erro
    goto configuracao ; Como deu erro eu volto ao loop/label "config"
;Escolha do Algoritmo:
    btfsc ((PORTE) and 07Fh), 0 ; Se ((PORTE) and 07Fh), 0 estiver setado em 0, pulo a linha e vou para a label "div_simples"
    call div_deslocamentos
    btfss ((PORTE) and 07Fh), 0 ; Como ele está setado em 0, vai ser direcionado ao chamado de "div_simples"
    call div_simples
resultado:
    movf q, W
    movwf PORTA
...
div_deslocamentos:
    ...
    return ; Ele volta para a linha após a chamada da função (linha do btfss ((PORTE) and 07Fh), 0)
